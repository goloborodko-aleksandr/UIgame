...
namespace Engine.AxGridUnityTools.Binders{
	...
	public class UIButtonDataBind : MonoBehaviourExt
	{
		...
		{
			if (button.interactable !=  Settings.Model.GetBool(enableField, defaultEnable))
				button.interactable = Settings.Model.GetBool(enableField, defaultEnable);
		}
